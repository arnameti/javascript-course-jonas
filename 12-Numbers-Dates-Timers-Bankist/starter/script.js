...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    // Add transfer date
    currentAccount.movemntsDates.push(new Date().toISOString());
    receiverAccount.movemntsDates.push(new Date().toISOString());
